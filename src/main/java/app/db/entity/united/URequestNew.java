 ...
 * describing the exact information about new Requests.
 * @author Alexey Yermachyonok
 * @version 1.0
 */

public class URequestNew {

    private static final Logger LOGGER = Logger.getLogger(URequestNew.class);
    ...
    public URequestNew(int idRequest, int idUser, String login, Date date, int days, int idRoomType, String roomType,
                       int rooms, int idRequestStatus, String requestStatus, String availRooms) {
    ...
    public URequestNew(Request request, String login, String roomType, String requestStatus, String availRooms) {
    ...
    public boolean equals(Object o) {
        ...
        URequestNew uRequest = (URequestNew) o;
