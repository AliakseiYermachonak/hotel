...
<jsp:include page="/WEB-INF/user.pages/header.jsp" flush="true" />
...
<c:if test="${param.menu=='requests' }">
    <jsp:include page="/WEB-INF/user.pages/request.jsp" flush="true" />
</c:if>
<c:if test="${param.menu=='rooms' }">
    <jsp:include page="/WEB-INF/user.pages/rooms.jsp" flush="true" />
</c:if>
<c:if test="${param.menu=='newRequest' }">
    <jsp:include page="/WEB-INF/user.pages/newRequest.jsp" flush="true" />
</c:if>
